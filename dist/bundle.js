...
eval("const input = (type) => {\n  const input = document.createElement('input');\n  input.type = type;\n\n  return input;\n};\n\nconst icon = (name) => {\n  const i = document.createElement('i');\n  i.className = `${name} icon`;\n\n  return i;\n};\n\nmodule.exports = { input, icon };\n\n//# sourceURL=webpack://Minimalist/./modules/List.js?");
...
eval("const saveToLocalStorage = (key, value) => (\n  localStorage.setItem(key, JSON.stringify(value))\n);\n\nconst getFromLocalStorage = (key) => JSON.parse(localStorage.getItem(key));\n\nmodule.exports = {\n  saveToLocalStorage,\n  getFromLocalStorage,\n};\n\n//# sourceURL=webpack://Minimalist/./modules/Storage.js?");
